...
(function (){
    ...
    var View = function( inst ) {
        this.init = function( data ) {
            seajs.use("core/widget/component/togglepanel/togglepanel.js",function(){
                LAPP.Component.Togglepanel({op:inst.options,componentData:data,callback:function(html){
                    inst.render(html);
                }});
            });
        };
    ...
    var TogglePanel = Klass.define(LAPP.BasicPlug, {
        ...
        setOptions : function( options ) {
            ...
            if( this.options.formData != undefined ){
