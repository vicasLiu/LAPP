...
(function(){
	...
	Search.prototype = {
		...
		createHtml: function (renderTarget) {
			...
			var self = this;
			var options = this.options;
           	seajs.use("core/widget/component/search/search.js",function(){
                	var search = LAPP.Component.Search({op:self.options,callback:function(html){
                	var $render = $('#'+renderTarget);
	                $render.html(html);
	                var $searchList = $('<div id="searchList" class="searchList"><ul></ul></div>');
	                $render.after($searchList);
		...
		fn: function(){
			var that = this
				, timeout
				, $searchIpt = $('.LAPP-component-search-div')
